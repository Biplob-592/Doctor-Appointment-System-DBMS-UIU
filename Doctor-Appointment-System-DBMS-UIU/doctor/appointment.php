...
<a href="?action=drop&id='.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.'" class="non-style-link">
  <button class="btn-primary-soft btn button-icon btn-delete" style="padding: 12px 20px; margin-top: 10px;">
    <i class="icon-class" style="margin-right: 8px;"></i> <!-- adjust class and margin as needed -->
